  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4 p-6">
      ...
      <p className="text-muted-foreground">
        This page is rendered by the reference plugin. It demonstrates the
        mirror layout between <code>app/apps/example/</code> and{" "}
        <code>frontend/src/apps/example/</code>.
      </p>
      <p>
        Replace this component with your own UI and import shared primitives
        from <code>@/components/ui/</code>.
      </p>
    </div>
  )
}
