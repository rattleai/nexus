...
class Plan(TimestampMixin, Base):
    ...
    tier: Mapped[PlanTier] = mapped_column(Enum(PlanTier, values_callable=lambda e: [m.value for m in e]), nullable=False)
...
class Subscription(TimestampMixin, Base):
    ...
    status: Mapped[SubscriptionStatus] = mapped_column(Enum(SubscriptionStatus, values_callable=lambda e: [m.value for m in e]), default=SubscriptionStatus.ACTIVE)
